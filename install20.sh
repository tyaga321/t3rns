...
export RPC_ENDPOINTS_ARBT='https://arb-sepolia.g.alchemy.com/v2/nsFz9fXLCbQp1ZTLyuc75lLkbMZxKoi8'

export RPC_ENDPOINTS_BSSP='https://base-sepolia.g.alchemy.com/v2/nsFz9fXLCbQp1ZTLyuc75lLkbMZxKoi8'

export RPC_ENDPOINTS_BLSS='https://blast-sepolia.g.alchemy.com/v2/nsFz9fXLCbQp1ZTLyuc75lLkbMZxKoi8'
export RPC_ENDPOINTS_OPSP='https://opt-sepolia.g.alchemy.com/v2/nsFz9fXLCbQp1ZTLyuc75lLkbMZxKoi8'
